<?php
$this->title = 'Labels and help messages';
?>
...
<h1>Demo: labels and help messages</h1>

<p>
	This is a demo of custom labels and help messages in Form. Try out the form below or skip to the <a href="#source">source code below</a>.
</p>
